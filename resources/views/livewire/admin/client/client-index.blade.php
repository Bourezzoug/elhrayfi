            ...
            <div class="m-5">
                ...
                <div class="col-span-3 md:col-span-2 lg:col-span-1 mr-3">
                    <x-select wire:model="categories" class="mt-1">
                        <option value="" readonly="true" hidden="true"
                                selected>{{ __('Villes') }}</option>
                        @forelse($villes as $key => $value)
                ...
                <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4">
                            <input type="checkbox" wire:model="selectedPosts" value="{{ $client->id }}" class="bg-neutral-50 border-neutral-200 childCheckbox">
                        </td>
                        ...
                        <td class="px-6 py-4">
                            ...
                            <span
                                class="inline-flex items-center gap-1 w-fit rounded-full bg-gray-50 px-2 py-1 text-xs font-semibold text-gray-600"
                            >
                            {{ date('jS M Y',strtotime($client->created_at)) }} 
                            </span>
                            </div>
                        </td>
                        <td class="px-6 py-4">

    ...
    <div class="w-full flex flex-col h-screen ml-56">
        ...
        <div class="ml-8 mt-20" wire:init="loadItems">
            ...
            <div class="m-5">
                    ...
                    <a href="{{ Route('offre.create') }}" class="flex items-center">
                ...
                <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                    ...
                    @forelse ($offres as $offres)
            
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4">
                            <input type="checkbox" wire:model="selectedPosts" value="{{ $offres->id }}" class="bg-neutral-50 border-neutral-200 childCheckbox">
                        </td>
                    <td class="px-6 py-4">
                        <span
                    ...
                    <td class="px-6 py-4">
                        ...
                        >
                        <span class="h-1.5 w-1.5 rounded-full bg-gray-600"></span>
                        {{ date('jS M Y',strtotime($offres->created_at)) }} 
                        </span>
                    </td>
                    ...
                    <td class="px-6 py-4">
                        ...
                        <div class="flex gap-4">
                            ...
                            <div class="cursor-pointer" wire:click="selectedItem('delete',{{ $offres->id }})"
                                        class="px-2">
...
<livewire:client.offre.offre-delete />

        ...
        <x-slot name="content">
            <div class="grid grid-cols-6 gap-3">
                <div class="col-span-3">
                    <label for="diplome" class="block text-sm font-medium leading-6 text-gray-900">Nom du diplome</label>
                    <div class="mt-2">
                ...
                <div class="col-span-3">
                    <label for="school_name" class="block text-sm font-medium leading-6 text-gray-900">Nom d'Entreprise</label>
                    <div class="mt-2">

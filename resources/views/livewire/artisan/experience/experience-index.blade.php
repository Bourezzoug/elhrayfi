    ...
    <div class="w-full flex flex-col h-screen md:ml-56">
        ...
        <div class="ml-8 mt-20" wire:init="loadItems">
            ...
            <div class="m-5">
                ...
                <a href="{{ Route('experience.create') }}" class="flex items-center">
                ...
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Nom d'Entreprise</th>
                ...
                <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4">
                            <input type="checkbox" wire:model="selectedPosts" value="{{ $experience->id }}" class="bg-neutral-50 border-neutral-200 childCheckbox">
                        </td>
                        ...
                        <td class="px-6 py-4">
                            ...
                            <div class="flex gap-4">
                                <div class="cursor-pointer" wire:click="selectedItem('update',{{ $experience->id }})"
                                    class="px-2">
                                    <x-svg.svg-update class="w-5 h-5 mr-2 transform hover:text-purple-500 hover:scale-110"/>
                                </div>

                                <div class="cursor-pointer" wire:click="selectedItem('delete',{{ $experience->id }})"
                                        class="px-2">
...
<livewire:artisan.experience.experience-update />
<livewire:artisan.experience.experience-delete />

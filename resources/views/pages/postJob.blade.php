                    ...
                    <form class="text-left">
                        ...
                        <div class="grid grid-cols-12 gap-4 mt-4">
                            <div class="col-span-12 ltr:text-left rtl:text-right">
                                ...
                                <input id="RegisterName" type="text" class="border border-slate-100 dark:border-slate-800 block w-full mt-1  h-[2.5rem] rounded px-2 py-2 text-[14px]" placeholder="Titre du poste">
                            </div>
                            ...
                            <div class="md:col-span-6 col-span-12 ltr:text-left rtl:text-right">
                                ...
                                <select class="border border-slate-100 dark:border-slate-800 block w-full mt-1  h-[2.5rem] rounded px-2 py-2 text-[14px]">
                            ...
                            <div class="md:col-span-6 col-span-12 ltr:text-left rtl:text-right">
                                ...
                                <div class="relative mt-1">
                                    ...
                                    <input type="number" class="border border-slate-100 dark:border-slate-800 block w-full mt-1  h-[2.5rem] rounded pr-2 pl-12 py-2 text-[14px]" placeholder="Le salaire que vous proposez" name="minsalary">
                                </div>
                            </div>
                            <div class="md:col-span-6 col-span-12 ltr:text-left rtl:text-right">
                        ...
                        <div class="grid grid-cols-12 gap-4 mt-4">
                            ...
                            <div class="md:col-span-6 col-span-12 ltr:text-left rtl:text-right">
                                ...
                                <input id="RegisterName" type="text" class="border border-slate-100 dark:border-slate-800 block w-full mt-1  h-[2.5rem] rounded px-2 py-2 text-[14px]" placeholder="Votre address">
                            </div>

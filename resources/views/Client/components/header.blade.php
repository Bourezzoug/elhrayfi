        ...
        <header x-data="{ isOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden bg-black">
            ...
            <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4">
                <a href="{{ Route('client.dashboard') }}" class="flex items-center active-nav-link text-white py-2 pl-4 nav-item">
                    <i class="fas fa-tachometer-alt mr-3"></i>
                    Dashboard
                </a>
                <a href="{{ Route('offre.index') }}" class="flex items-center text-white opacity-75 hover:opacity-100 py-2 pl-4 nav-item">
                    <i class="fa-solid fa-users mr-3"></i>
                    Offres du travail
                </a>
                <a href="{{ Route('client.profile') }}" class="flex items-center text-white opacity-75 hover:opacity-100 py-2 pl-4 nav-item">
                ...
                {{-- <form method="POST" action="{{ route('logout') }}" x-data>
                    ...
                    <x-dropdown-link href="{{ route('logout') }}"
                             ...
                             <button type="submit">
                                <i class="fas fa-sign-out-alt mr-3"></i>
                                <span class="text-white opacity-75 hover:opacity-100">Sign Out</span>
                             </button>
                    </x-dropdown-link>
                </form> --}}
            </nav>
